...
- `patterns/handle-with-care.md`: "The word: 'delicate' — why it works, and
  what it does" — the word named and its mechanism stated in plain terms,
  at the author's ask; the wording made technical after his read-through.
...
- The word: cocohaim is a *method*; *model* is reserved for the language
  model; *mechanism* for the why. Renamed across the text
  ([0007](decisions/0007-method-not-model.md)).
...
- [cocohaim.md](cocohaim.md): the chapters joined into one read-through
  (mechanical, for shape); the entry page marked "under reorganization"
  ([0002](decisions/0002-chapters-are-the-source.md)).
- References 13–33.
